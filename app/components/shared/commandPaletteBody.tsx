 ...
 *
 * Loaded lazily by commandPalette.tsx (the shell app/layout.tsx mounts),
 * which also owns the global ⌘K shortcut so the keybinding works before
 * this chunk exists.
 *
...
export default function CommandPaletteBody() {
  ...
  // Reads the one shared CurrentUserProvider (see lib/auth.ts).
