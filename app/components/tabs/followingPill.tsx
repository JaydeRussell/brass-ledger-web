...
export default function FollowingPill({ label, onStop }: FollowingPillProps) {
  return (
    <div className="flex items-center gap-1.5 rounded-full border border-brass-500/30 bg-brass-500/15 py-1 pl-3 pr-1.5 text-xs font-medium text-brass-400">
      ...
      <button
        ...
        className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full text-brass-400 hover:bg-brass-500/20"
      >
        ×
      </button>
    </div>
