...
// NavDrawerBody is built on ui/dialog.tsx's Radix-backed Dialog, which
...
const { default: NavDrawerBody } = await import("./navDrawerBody.tsx");
...
function renderInProviders() {
  return renderToStaticMarkup(
    React.createElement(
      ...
      null,
      React.createElement(NavProvider, null, React.createElement(NavDrawerBody))
    )
  );
}
